interfaces {
    ethernet eth0 {
        address 10.0.54.201/24
        duplex auto
        smp-affinity auto
        speed auto
    }
    ethernet eth1 {
        address 172.26.32.1/24
        duplex auto
        smp-affinity auto
        speed auto
    }
...
system {
    ...
    login {
        user vyos {
            authentication {
                encrypted-password $6$PwSKKIGqg3$l/PxeGurXe9LuS1tapv3vFQwjg6zpgKQGyhO1RuP5VQA40RxAcIahI.teAdLqG.gT6zWzE0.j.P0Ha4lPlRb10
