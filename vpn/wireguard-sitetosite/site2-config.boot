interfaces {
    ethernet eth0 {
        address dhcp
        hw-id 00:50:56:ae:8d:4b
    }
    ethernet eth1 {
        address 192.168.34.1/24
        hw-id 00:50:56:ae:eb:e5
    }
    loopback lo {
    }
    wireguard wg0 {
        address 10.32.47.3/31
        description "Site to Site to SITE1"
        peer SITE1 {
            address 10.21.21.71
            ...
            port 2224
            pubkey 321igxlao+uB+PhZ92BETLKGoGpc1rYQfF/wiqaYGR8=
        }
        port 2224
        private-key site1
    }
